        ...
        <form name="facetly_settings" method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php _e(":"); ?></td>
                    <td><input type="text" name="facetly_server" value="<?php echo $server; ?>" size="50">
                        <?php _e(" ex: http://sg1.beta.facetly.com/1"); ?></td>
                </tr>
                <tr>
                    <td><?php _e("Search Limit Setting"); ?></td>
                    <td><?php _e(":"); ?></td>
                    <td><input type="text" name="facetly_limit" value="<?php echo $limit; ?>" size="50">
                        <?php _e(" ex: 5"); ?></td>
                </tr>
...
?>
       <form name="facetly_copy" method="post" action="<?php
    echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']);
?>">  
            <input type="hidden" name="facetly_copy_hidden" value="Y">  
            <table>
                <tr>
                    <td><?php echo "<h4>" . __('Copy facetly_search_template.php and searchform.php to your current active theme') . "</h4>";
?>  </td>
                </tr>
                <tr>
                    <td>
