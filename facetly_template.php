...
?>  
        <?php
    echo "<h4>" . __('Facetly Template') . "</h4>";
?>  
        <form name="facetly_settings" method="post" action="<?php
...
?>">  
    ...
    _e("Search Template:");
?></td>
                    <td><textarea name="tplsearch" cols="150" rows="20"><?php
    echo $tplsearch;
?></textarea></td>
                </tr>
                <tr>
    ...
    _e("Facet Template:");
?></td>
                    <td><textarea name="tplfacet" cols="150" rows="20"><?php
    echo $tplfacet;
?></textarea></td>
                </tr>
                <tr>
